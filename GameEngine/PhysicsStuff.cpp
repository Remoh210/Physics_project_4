...
////}
//
//bool AreSpheresPenetrating( cGameObject* pA, cGameObject* pB );
//
//bool TestForCollision( cGameObject* pA, cGameObject* pB );
//
...
////	for ( std::vector< cGameObject* >::iterator itMesh = vec_pObjectsToDraw.begin();
////		  itMesh != vec_pObjectsToDraw.end(); itMesh++ )
////	{
////		cGameObject* pCurMesh = *itMesh;		 
////
...
//////
////		}//if ( pCurMesh
////	}//for ( std::vector< cGameObject*
////
////	if (vec_cur_AABB_tris.size() > 0) 
////	{
////		// Test for collisions
////		for (std::vector< cGameObject* >::iterator itObjectA = vec_pObjectsToDraw.begin();
////			itObjectA != vec_pObjectsToDraw.end(); itObjectA++)
////		{
////			cGameObject* pCurObj = *itObjectA;
////
...
////
////		for ( std::vector< cGameObject* >::iterator itObjectB = vec_pObjectsToDraw.begin();
////				itObjectB != vec_pObjectsToDraw.end(); itObjectB++ )
////		{
////
////			cGameObject* pObjectA = *itObjectA;
////			cGameObject* pObjectB = *itObjectB;
////			// Same? 
////
...
////
////						
////						if ( (pObjectA->shapeType == cGameObject::SPHERE) && (pObjectB->shapeType == cGameObject::SPHERE) )
////						{
...
////						}
////						else if ( (pObjectA->shapeType == cGameObject::SPHERE) && (pObjectB->shapeType == cGameObject::TRIANGLE) )
////						{
...
//}
//
//bool SphereTraingleTest( cGameObject* pSphere, cGameObject* pTriangle )
//{
...
//
//	// Sphere - sphere
//	if ( (pA->shapeType == cGameObject::SPHERE) && 
//		 (pB->shapeType == cGameObject::SPHERE ) )
//	{
//		return AreSpheresPenetrating( pA, pB );
//	}
//	else if ( (pA->shapeType == cGameObject::SPHERE ) && 
//			  (pB->shapeType == cGameObject::TRIANGLE ) )
//	{
